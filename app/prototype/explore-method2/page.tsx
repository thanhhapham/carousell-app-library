...
export default function ExploreMethod2Page() {
  ...
  return (
    <>
      {/* METHOD 2: Fixed positioning */}
      <div className="fixed top-0 left-0 right-0 z-[100] bg-background-base max-w-[375px] mx-auto">
        {/* Status Bar */}
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-1 pb-20">
          ...
          <div className="h-96 bg-gray-100 m-4 rounded-lg flex items-center justify-center">
            <p className="text-gray-500">Extra content to test scrolling - METHOD 2</p>
          </div>
        </main>
