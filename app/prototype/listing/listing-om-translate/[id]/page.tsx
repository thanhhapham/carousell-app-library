...
import { ShoppingCart, MoreHorizontal, ChevronRight, Star, Sparkles } from "lucide-react"
...
export default function ListingOMTranslatePage() {
        ...
        <div className="px-4 py-4 space-y-6">
          ...
          <div>
            <div className="flex items-start justify-between gap-2 mb-2">
              <h1 className="text-xl font-bold text-content-primary flex-1">
                WTS Nike Air Force x Peaceminusone Paranoise 3.0
              </h1>
              {/* Translate button */}
              <button className="flex-shrink-0 flex items-center gap-1 px-2.5 py-1 rounded-full border border-stroke-boundary bg-background-base text-content-primary text-sm font-medium mt-0.5">
          ...
          <div>
            ...
            <div className="flex gap-3 overflow-x-auto pb-2 -mx-4 px-4">
              ...
              {/* Review cards */}
              {[
                { text: "I just bought an iPhone from Carousell Certified and it was delivered very fast, phone is in perfect working conditions and i can't wait to share wit ..." },
                { text: "I just bought an iPhone from Carousell Certified and it was delivered very fast, phone is in perfect working ..." },
              ].map((review, i) => (
                <div key={i} className="flex-shrink-0 w-[328px] bg-background-base border border-stroke-boundary rounded-lg p-4">
                  <div className="space-y-3">
                    ...
                    <p className="text-middle-reg text-content-primary">{review.text}</p>
                    <div className="flex items-center gap-2">
              ...
              <div className="flex-shrink-0 w-[328px] bg-background-base border border-stroke-boundary rounded-lg p-4">
                <div className="flex space-y-3">
                  ...
                  <div className="w-16 h-16 bg-gray-200 rounded-lg ml-3 flex-shrink-0">
                    <img src="/images/iphone-11-pro.png" alt="Product" className="w-full h-full object-cover rounded-lg" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-4">
              <Button variant="secondary" className="flex-1">Make offer</Button>
              <Button variant="secondary" className="flex-1">Chat</Button>
            </div>
          </div>
