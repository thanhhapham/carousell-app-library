...
export default function TopNavTitleActionPage() {
  return (
    <ComponentPage
      title="Top Nav / Title & Action"
      description="Top navigation with title and action buttons provides consistent navigation patterns across the application. It adapts to different contexts with various button configurations and responsive title sizing."
    >
